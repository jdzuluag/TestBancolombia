...
public class CompleteNinthCycle implements Task {
    private String multiples, operation, letter, count;

    public CompleteNinthCycle(String multiples, String operation, String letter, String count) {
    ...
    public static CompleteNinthCycle completeNinthCycle(String multiples, String letter, String operation, String count){
        return Tasks.instrumented(CompleteNinthCycle.class, multiples, letter, operation, count);
    }
}
