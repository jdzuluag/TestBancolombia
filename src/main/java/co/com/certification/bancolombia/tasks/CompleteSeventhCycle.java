...
public class CompleteSeventhCycle implements Task {
    private String multiples, multiples2, operation, letter, count;

    public CompleteSeventhCycle(String multiples, String multiples2, String operation, String letter, String count) {
    ...
    public static CompleteSeventhCycle completeSeventhCycle(String multiples, String multiples2, String operation, String letter, String count){
        return Tasks.instrumented(CompleteSeventhCycle.class, multiples, multiples2, operation, letter, count);
    }
}
