...
public class CompleteTenthCycle implements Task {
    private String multiples, multiples2, operation, letter, count;

    public CompleteTenthCycle(String multiples, String multiples2, String operation, String letter, String count) {
    ...
    public static CompleteTenthCycle completeTenthCycle(String multiples, String multiples2, String operation, String letter, String count){
        return Tasks.instrumented(CompleteTenthCycle.class, multiples, multiples2, operation, letter, count);
    }
}
